 ...
 */
final class Version20210329122304 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , nom VARCHAR(30) DEFAULT NULL, prenom VARCHAR(30) DEFAULT NULL, anniversaire DATE DEFAULT NULL, isadmin BOOLEAN DEFAULT \'0\' NOT NULL)');
